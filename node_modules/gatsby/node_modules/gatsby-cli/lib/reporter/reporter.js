...
class Reporter {
  constructor() {
    (0, _defineProperty2.default)(this, "stripIndent", _commonTags.stripIndent);
    (0, _defineProperty2.default)(this, "format", _chalk.default);
    (0, _defineProperty2.default)(this, "setVerbose", (_isVerbose = true) => {
      isVerbose = _isVerbose;
    });
    (0, _defineProperty2.default)(this, "setNoColor", (isNoColor = false) => {
      if (isNoColor) {
    ...
    (0, _defineProperty2.default)(this, "panic", (errorMeta, error) => {
    ...
    (0, _defineProperty2.default)(this, "panicOnBuild", (errorMeta, error) => {
      const reporterError = this.error(errorMeta, error);
    ...
    (0, _defineProperty2.default)(this, "error", (errorMeta, error) => {
      let details = {
        context: {}
      ...
      if (error) {
        ...
        details = Object.assign({}, errorMeta); // 5.
        //    reporter.error('foo');
    ...
    (0, _defineProperty2.default)(this, "uptime", prefix => {
      this.verbose(`${prefix}: ${(process.uptime() * 1000).toFixed(3)}ms`);
    });
    (0, _defineProperty2.default)(this, "verbose", text => {
      if (isVerbose) {
    ...
    (0, _defineProperty2.default)(this, "success", text => reporterActions.createLog({
      level: _constants.LogLevels.Success,
      text
    }));
    (0, _defineProperty2.default)(this, "info", text => reporterActions.createLog({
      level: _constants.LogLevels.Info,
      text
    }));
    (0, _defineProperty2.default)(this, "warn", text => reporterActions.createLog({
      level: _constants.LogLevels.Warning,
      text
    }));
    (0, _defineProperty2.default)(this, "log", text => reporterActions.createLog({
      level: _constants.LogLevels.Log,
      text
    }));
    (0, _defineProperty2.default)(this, "pendingActivity", reporterActions.createPendingActivity);
    (0, _defineProperty2.default)(this, "completeActivity", (id, status = _constants.ActivityStatuses.Success) => {
      reporterActions.endActivity({
        id,
        status
      });
    });
    (0, _defineProperty2.default)(this, "activityTimer", (text, activityArgs = {}) => {
      let parentSpan = activityArgs.parentSpan,
          id = activityArgs.id,
          tags = activityArgs.tags;
    ...
    (0, _defineProperty2.default)(this, "phantomActivity", (text, activityArgs = {}) => {
      let parentSpan = activityArgs.parentSpan,
          id = activityArgs.id,
          tags = activityArgs.tags;
      const spanArgs = parentSpan ? {
    ...
    (0, _defineProperty2.default)(this, "createProgress", (text, total = 0, start = 0, activityArgs = {}) => {
      let parentSpan = activityArgs.parentSpan,
          id = activityArgs.id,
          tags = activityArgs.tags;
      const spanArgs = parentSpan ? {
    ...
    (0, _defineProperty2.default)(this, "_setStage", () => {});
  }
