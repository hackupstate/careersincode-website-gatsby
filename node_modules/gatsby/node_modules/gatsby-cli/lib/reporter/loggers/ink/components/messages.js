...
const ColorSwitcher = (_ref) => {
  ...
  return (/*#__PURE__*/_react.default.createElement(_ink.Color, props, children)
  );
};

const createLabel = (text, color) => (...props) => /*#__PURE__*/_react.default.createElement(ColorSwitcher, Object.assign({
  [color]: true
}, props), text);
