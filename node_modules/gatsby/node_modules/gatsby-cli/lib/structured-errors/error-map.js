...
const errors = {
  ...
  "85920": {
    text: context => {
      const generalMessage = (0, _commonTags.stripIndents)(`You might have a typo in the variable name "${context.variableName}" or you didn't provide the variable via context to this page query. Have a look at the docs to learn how to add data to context:

      https://www.gatsbyjs.org/docs/page-query/#how-to-add-query-variables-to-a-page-query`);
      const staticQueryMessage = (0, _commonTags.stripIndents)(`If you're not using a page query but a StaticQuery / useStaticQuery you see this error because they currently don't support variables. To learn more about the limitations of StaticQuery / useStaticQuery, please visit these docs:
