...
function J(a) {
  ...
  function e(a) {
    a.operation && "mutation" === a.operation.operationName ? m(a) : a.operation && "query" === a.operation.operationName && R(a);
  }
  function f(a) {
    return !E(a) && !b(a);
  }
  var m, R, k = a.forward, l = a.client, g = a.dispatchDebug, h = new Map;
...
function ssrExchange(a) {
  function b(b) {
    ...
    return function(b) {
      var m = a && "boolean" == typeof a.isClient ? !!a.isClient : !c.suspense, g = share(b);
      b = h(filter(d)(g));
      g = map(e)(filter(f)(g));
      m ? g = tap(l)(g) : b = tap(k)(b);
      return merge([ b, g ]);
    };
  }
  function c(a) {
  ...
  return function(a) {
    function d(a) {
      ...
      return make((function(c) {
        ...
        function f() {
          m || (m = !0, "subscription" === a.operationName && l.reexecuteOperation(_extends({}, a, {
            operationName: "teardown"
          })), h());
        }
        var k, g = c.next, h = c.complete, m = !1;
