        ...
        <Row xs="3">
          <Col>
            <div className={footerStyles.footerText}>
              <h4 className={footerStyles.footerTextBold}>
                {" "}
          ...
          <Col>
            <div className={footerStyles.footerText}>
              ...
              <Row className={footerStyles.centerItems}>
                <a
                ...
                >
                  ...
                  <img
                    src={FB}
                    alt={
                      content.ui.footer_main_content.connect.facebook.alt_text
                    }
                ...
                >
                  ...
                  <img
                    src={TW}
                    alt={
                      content.ui.footer_main_content.connect.twitter.alt_text
                    }
                    className={footerStyles.logo}
                  />{" "}
                </a>
                ...
                >
                  ...
                  <img
                    src={Insta}
                    alt={
                      content.ui.footer_main_content.connect.instagram.alt_text
                    }
                    className={footerStyles.logo}
                  />{" "}
                </a>
              ...
              <Row className={footerStyles.centerItems}>
                ...
                >
                  ...
                  <img
                    src={LinkedIn}
                    alt={
                      content.ui.footer_main_content.connect.linkedin.alt_text
                    }
                    className={footerStyles.logo}
                  />{" "}
                </a>
                ...
                >
                  ...
                  <img
                    src={YT}
                    alt={
                      content.ui.footer_main_content.connect.youtube.alt_text
                    }
                    className={footerStyles.logo}
                  />{" "}
                </a>
