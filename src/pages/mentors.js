				...
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							<CardHeader tag="h3">Jesse Peplinski</CardHeader>
							<CardImg
								top
								width="100%"
								src={Jesse}
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							/>
							<CardText>
								<p className={instructorStyles.cardText}>Blockchain</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
								<a
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									You can message me on Signal or Facebook or LinkedIn. Touches
									with me are require once every other week. This can be via one
									on one or popping into a group session or by email. Topics
									include anything around job searching, entrepreneur
									goals/freelancing, networking, adding skills to resume, etc.
									We'll be covering each part of the job search in our Modules
									every 3 weeks.
								</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
				...
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									I’m available for 1:1 pair programming, input on your
									capstone, or additional tutoring for topics that you might
									need a little bit more help on from class. The top categories
									I mentor for (in no particular order) are In no particular
									order: Full Stack Dev, HTML, Bootstrap, Node, React, SQL,
									Entrepreneurship, Capstone, Wireframing.
								</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
								<a
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									Hi I'm Gus! I work at Density Inc and do a lot of frontend and
									full-stack programming. The top categories I mentor are
				...
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									I am available to chat about anything. I am a graduate of the
									first cohort and can help with some of the struggles you may
									experience along the way. The top caterogires I mentor for are
									Capstone, HTML, CSS, Wireframing, Project Management, General
									Questions
								</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									I currently work at the Program for Careers in Code and am
									willing to help you plug in what you've learned in each module
									towards to the development of your capstone. I can also help
									you with your wireframes, figuring out code content, correct
									errors, and with answering your code accessibility questions.
									The top categories I mentor for are Front End Web Development
									(HTML, CSS, Bootstrap, W3CSS, Javascript)
								</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
								<a
					...
					<Col sm="4">
						<Card body className={("shadow-sm", instructorStyles.cardSize)}>
							...
							<CardText>
								<p className={instructorStyles.cardText}>
									I'm available to help with HTML, CSS, basic Javascript, React
									or any general questions regarding Capstones, organization
									etc. You can schedule 30 min or 60 minute sessions.
								</p>
							</CardText>
							<CardFooter className={instructorStyles.cardFooter}>
								<a
