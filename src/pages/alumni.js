		...
		>
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Markell Osborne</CardHeader>
							<CardImg
								top
								width="100%"
								src={markellosborne}
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Tiffany Williams</CardHeader>
							<CardImg
								top
								width="100%"
								src={tiffanywilliams}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Wayne Boyd</CardHeader>
							<CardImg
								top
								width="100%"
								src={wayneboyd}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Chaz Dickerson</CardHeader>
							<CardImg
								top
								width="100%"
								src={chazdickerson}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Scotyia Bain</CardHeader>
							<CardImg
								top
								width="100%"
								src={scotyia}
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Corey Mitchell</CardHeader>
							<CardImg
								top
								width="100%"
								src={coreymitchell}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Strange Maeweather</CardHeader>
							<CardImg
								top
								width="100%"
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Nicole Broadnax</CardHeader>
							<CardImg
								top
								width="100%"
								src={nicoleb}
		...
		>
			<Row className={alumniStyles.alumniCardRow}>
				...
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Brielle Dailey</CardHeader>
							<CardImg
								top
								width="100%"
								src={brielle}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Dominique Wynn</CardHeader>
							<CardImg
								top
								width="100%"
								src={dominique}
					...
					<Col sm="4">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Jaheal Smith</CardHeader>
							<CardImg
								top
								width="100%"
								src={jaheal}
			...
			<Row className={alumniStyles.alumniCardRow}>
				<CardDeck>
					...
					<Col sm="6">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Shah Mansoor</CardHeader>
							<CardImg
								top
								width="100%"
								src={shah}
							...
							<CardBody>
								<CardText>
									...
									>
										<p className={alumniStyles.cardText}>
											Professional and Personalized Interpreting Services
										</p>
									</a>{" "}
								</CardText>
							</CardBody>
					...
					<Col sm="6">
						<Card body className={("shadow-sm", alumniStyles.cardSize)}>
							<CardHeader tag="h3">Susan Baiter</CardHeader>
							<CardImg
								top
								width="100%"
								src={susan}
							...
							<CardBody>
								<CardText>
									...
									>
										<p className={alumniStyles.cardText}>
											Music Festivals of New York State
										</p>
									</a>{" "}
								</CardText>
							</CardBody>
